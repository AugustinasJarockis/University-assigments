        ...
        if(format_str[i] == '%' && format_str[i + 1] == '@')
        {
            ...
            if(format_str[i] == '}')
            {
                ...
                do
                {
                    ...
                    while(!((format_str[i] == '%' && format_str[i + 1] == '}') || (format_str[i] == '%' && format_str[i + 1] == '$')))
                    {
                        end_value[end_value_c][symbol_nr] = format_str[i];
                        symbol_nr++;
                        i++;
                    }
                    end_value_c++;
            ...
            else if(format_str[i] == 's')
            {
                ...
                for(int i2 = 0; i2 < end_value_c; i2++)
                {
                    int end_len = strlen(end_value[i2]) - 1;
                    for(int i3 = end_len; i3 >= 0; i3--)
                    {
                        if(number_str[digit_c - end_len + i3 - 1] != end_value[i2][i3])
                        {
                            printf("Input doesn't end with %s\n", end_value[i2]);
                            return 0;
                        }
                    }
                }
            ...
            {
                printf("ERROR: variable type not specified\n");
            }
        }
